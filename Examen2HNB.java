 ...
 */
package examen2.hnb;
//import java.util.Scanner;Scanner entrada.

/**
 *
 * @author Usuario
 */
public class Examen2HNB {
     ...
     */
      ...
      // TODO code application logic here double guitarra = 1250.45;
...
System.out.println("Nombre del instrumento");
 String nombret = lectura.nextLine():
...
double ganacial = guitarra - precioCompral;
double ganacia2 = piano - precioCompra2;

double ganacia3 bajo precioCompra3;

double total1 = (ganacial/precioCompra1)*100;
